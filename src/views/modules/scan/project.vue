        ...
        <el-row v-for="(item, index) in dataList" :key="item.id" v-if="index%2==0">
          <el-col :span="12">
            <div class="grid-content project-col" @click="showPointList(item.id)">
              <div class="p-name">
                <span v-if="isAdmin==1">{{item.userName}}&nbsp;--&nbsp;</span>
                <span>{{ item.name }}</span>
              ...
              <div class="p-desc">
                <el-row :gutter="20">
                  <el-col :span="4" v-if="item.isCompleted == 0">
                    <div class="desc-header" style="color: limegreen">扫描中</div>
                  </el-col>
                  <el-col :span="4" v-if="item.isCompleted == 1">
                    <div class="desc-header" style="color: dodgerblue">扫描完成</div>
                  </el-col>
                  <el-col :span="4">
                ...
                <el-row :gutter="20">
                  <el-col :span="4">
                    <div class="desc-content">
                      <i :class="{'scanning iconfont icon-avdsloudongsaomiao': item.isCompleted == 0,'scan_end iconfont icon-avdsloudongsaomiao': item.isCompleted == 1}"></i>
                    </div>
                  </el-col>
                  <el-col :span="4">
          ...
          <el-col :span="12" v-if="index+1 < dataList.length">
            <div class="grid-content project-col" @click="showPointList(dataList[index + 1].id)">
              <div class="p-name">
                <span v-if="isAdmin==1">{{ dataList[index + 1].userName }}&nbsp;--&nbsp;</span>
              ...
              <div class="p-desc">
                ...
                <el-row :gutter="20">
                  <el-col :span="4">
                    <div class="desc-content">
                      <i :class="{'scanning iconfont icon-avdsloudongsaomiao': dataList[index + 1].isCompleted == 0,'scan_end iconfont icon-avdsloudongsaomiao': dataList[index + 1].isCompleted == 1}"></i>
                    </div>
                  </el-col>
                  <el-col :span="4">
...
export default {
  ...
  mounted() {
    let that = this;
    that.isAdmin = sessionStorage.getItem(commonkey.isAdminKey)
    that.getDataList();
