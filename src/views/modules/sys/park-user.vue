  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__user">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item>
          <el-select v-model="dataForm.unitId" filterable clearable :placeholder="$t('unit.unitName')">
            <el-option v-for="item in options" :key="item.unitId" :label="item.name" :value="item.unitId">
            </el-option>
          </el-select>
        </el-form-item>
<!--        <el-form-item>-->
<!--          <ren-dept-tree v-model="dataForm.unitId" :placeholder="$t('unit.unit')" :query="true" :options="options"></ren-dept-tree>-->
<!--        </el-form-item>-->
        <el-form-item>
...
import AddOrUpdate from './park-user-add-or-update'
export default {
